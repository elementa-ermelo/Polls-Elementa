...
<div style="margin-bottom: 12px;">
    <a class="btn" href="<?php echo e(route('admin.polls.show', $poll)); ?>">← Terug naar poll</a>
    <h1><?php echo e($question->exists ? 'Vraag bewerken' : 'Nieuwe vraag'); ?></h1>
</div>

<form class="card" method="post" action="<?php echo e($action); ?>">
    <?php echo csrf_field(); ?>
    <?php if($method !== 'POST'): ?>
    ...
    <div class="field">
        ...
        <div style="display: flex; gap: 8px; align-items: flex-start;">
            <textarea id="question" name="question" rows="2" required style="flex: 1;"><?php echo e(old('question', $question->question)); ?></textarea>
    ...
    <input type="hidden" id="help_text" name="help_text" value="<?php echo e(old('help_text', $question->help_text ?? '')); ?>">
    ...
    <div class="field">
        ...
        <select id="type" name="type" required>
            <?php $__currentLoopData = $typeLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($key); ?>" <?php if(old('type', $question->type ?? $poll->type) === $key): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
    ...
    <div class="field">
        ...
        <textarea id="options_text" name="options_text" rows="8" style="display: none;"><?php echo e(old('options_text', $optionsText)); ?></textarea>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Elementa-polls\Polls-Elementa\resources\views\admin\polls\question-form.blade.php ENDPATH**/ ?>
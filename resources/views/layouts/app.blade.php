...
<head>
    ...
    <title>{{ $title ?? 'Polls Elementa' }}</title>
    <style>
        :root {
...
<nav class="topnav">
    <a href="{{ auth()->check() ? route('admin.polls.index') : route('polls.index') }}" class="topnav-brand">
        Polls Elementa
    </a>

    @auth
        <a href="{{ route('admin.polls.index') }}" class="nav-link">Polls</a>
        <a href="{{ route('admin.reports.index') }}" class="nav-link">Rapportage</a>
        @if(auth()->user()->is_admin)
            <a href="{{ route('admin.users.index') }}" class="nav-link">Gebruikers</a>
        @endif
        ...
        <a href="{{ route('profile.edit') }}" class="nav-user">
            @if(auth()->user()->logo)
                <img src="{{ asset('storage/' . auth()->user()->logo) }}" alt="{{ auth()->user()->name }}" class="nav-avatar">
            @else
    ...
    @else
        <div class="nav-spacer"></div>
        <a href="{{ route('login') }}" class="btn" style="font-size:14px;">Inloggen</a>
        <a href="{{ route('register') }}" class="btn btn-primary" style="font-size:14px;">Registreren</a>
    @endauth
</nav>
